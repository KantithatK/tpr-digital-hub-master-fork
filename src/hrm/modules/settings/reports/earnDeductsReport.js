...
//   { header: 'ชื่อ (อังกฤษ)', dataKey: 'name_en' },
...
export async function fetchRows(filters = {}) {
  ...
  try {
    ...
    // For compatibility with the existing filter dialog which provides startGroupId/endGroupId
    // treat them as code range boundaries when present
