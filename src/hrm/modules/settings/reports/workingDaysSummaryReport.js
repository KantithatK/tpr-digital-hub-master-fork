...
export async function fetchRows(filters = {}) {
  // filters.startGroupId / endGroupId treated as calendar.code
  ...
  try {
    ...
    // Aggregate counts per year-month
    const map = {}; // key: `${year}-${monthIndex}` -> { holiday: n, annual: n }
    ...
    // Build result rows sorted by year, month
